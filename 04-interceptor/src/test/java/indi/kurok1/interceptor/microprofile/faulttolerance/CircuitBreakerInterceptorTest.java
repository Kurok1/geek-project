 ...
 */
package indi.kurok1.interceptor.microprofile.faulttolerance;

import org.eclipse.microprofile.faulttolerance.CircuitBreaker;
import org.eclipse.microprofile.faulttolerance.exceptions.CircuitBreakerOpenException;
import indi.kurok1.interceptor.ReflectiveMethodInvocationContext;
...
public class CircuitBreakerInterceptorTest {
    ...
    public void testFailOn() throws Throwable {
        ...
        assertTrue(slidingWindow.shouldReset());
        assertTrue(slidingWindow.isOpen());
        assertFalse(slidingWindow.isClosed());
        assertFalse(slidingWindow.isHalfOpen());
        interceptor.execute(context);
    }
