 ...
 */
package indi.kurok1.microprofile.rest;
...
import static indi.kurok1.rest.util.PathUtils.resolvePath;
...
public class ReflectiveRequestTemplateResolver implements RequestTemplateResolver {
    ...
    private List<AnnotatedParamMetadata> resolveAnnotatedParamMetadata(Method resourceMethod) {
        ...
        for (int index = 0; index < parameters.length; index++) {
            ...
            for (Class<? extends Annotation> annotationType : RequestTemplate.SUPPORTED_PARAM_ANNOTATION_TYPES) {
